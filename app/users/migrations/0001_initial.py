    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('whatsapp_profile', models.CharField(blank=True, max_length=20, null=True, verbose_name='Whatsapp')),
                ...
                ('basic_services', models.ManyToManyField(blank=True, to='users.basicservice')),
                ('features', models.ManyToManyField(blank=True, to='users.feature')),
                ('massage_for', models.ManyToManyField(related_name='specialists', related_query_name='specialist', to='users.massagefor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.basicservice')),
                ('specialist', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='users.specialistprofile')),
            ],
        ),
    ]
